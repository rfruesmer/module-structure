...
describe("circular-module-dependency-02", function() {
    ...
    const tests = [
        {rootDir: "test/resources/es6/circular-module-dependency-02", moduleType: "es6", extension: ".js"},
        {rootDir: "test/resources/ts/circular-module-dependency-02", moduleType: "ts", extension: ".ts"}
    ];
